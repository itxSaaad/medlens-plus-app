...
See [../ai/01-EXTRACTION_PIPELINE.md](../03-ai/01-EXTRACTION_PIPELINE.md) for the
implementation-level detail behind steps 2-9 below (OCR/parsing engine,
extraction algorithm, confidence scoring).
