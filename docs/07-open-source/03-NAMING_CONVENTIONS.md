...
Branch **from `main`**. PR target: **`main`** — trunk-based, single branch (see [`04-BRANCHING_STRATEGY.md`](./04-BRANCHING_STRATEGY.md)).
...
See also: [`05-COMMIT_STRATEGY.md`](./05-COMMIT_STRATEGY.md), [`04-BRANCHING_STRATEGY.md`](./04-BRANCHING_STRATEGY.md), [`10-PR_REVIEW_AND_PROTECTION_POLICY.md`](./10-PR_REVIEW_AND_PROTECTION_POLICY.md).
