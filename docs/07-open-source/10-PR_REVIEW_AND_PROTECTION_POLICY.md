...
4. Approval requirements (see [`docs/06-ops/04-BRANCH_PROTECTION_SETUP.md`](../06-ops/04-BRANCH_PROTECTION_SETUP.md)):
...
Setup details: [`08-TOOLING_SETUP.md`](./08-TOOLING_SETUP.md).
...
Trunk-based — see [`04-BRANCHING_STRATEGY.md`](./04-BRANCHING_STRATEGY.md). Merge only after validations pass.
