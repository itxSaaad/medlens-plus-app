...
| Branch protection + CODEOWNERS          | [`.github/branch-protection.yml`](../.github/branch-protection.yml), [`04-BRANCH_PROTECTION_SETUP.md`](./04-BRANCH_PROTECTION_SETUP.md) |
| Conventional commits / semantic release | Commitlint + [`.releaserc.json`](../.releaserc.json)                                                                                    |
| PAT hygiene                             | Single `GH_PAT` secret — [`05-GITHUB_AUTOMATION_PAT.md`](./05-GITHUB_AUTOMATION_PAT.md)                                                 |
...
See also: [`08-TOOLING_SETUP.md`](../07-open-source/08-TOOLING_SETUP.md), [`05-GITHUB_AUTOMATION_PAT.md`](./05-GITHUB_AUTOMATION_PAT.md).
