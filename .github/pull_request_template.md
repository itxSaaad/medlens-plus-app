...
> **PR size (recommended):** ≤150 changed files for AI review tools; ≤400 lines meaningful diff. Split or use modular commits on the feature branch if larger. AI reviews (CodeRabbit, Copilot) are **manual** — see [`docs/07-open-source/08-TOOLING_SETUP.md`](docs/07-open-source/08-TOOLING_SETUP.md).
