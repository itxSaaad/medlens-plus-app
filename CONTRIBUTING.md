...
1. Fork repository
2. Sync `main`, then create branch per [`03-NAMING_CONVENTIONS.md`](docs/07-open-source/03-NAMING_CONVENTIONS.md): `feat/TKT-XXX-short-slug` **from `main`**
...
8. Request **CodeRabbit** (`@coderabbitai review`) and **Copilot** (assign as reviewer) **manually** when the PR is ready — see [`docs/07-open-source/08-TOOLING_SETUP.md`](docs/07-open-source/08-TOOLING_SETUP.md)
9. Hotfixes: branch from `main`, PR to **`main`** (sync workflow opens `main` → `develop` PR when needed — see [`04-BRANCHING_STRATEGY.md`](docs/07-open-source/04-BRANCHING_STRATEGY.md))
...
- `docs/07-open-source/06-GITHUB_PROJECTS.md` — hierarchy, milestones, and status model
